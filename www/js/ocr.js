...
- پانویس‌ها → فقط وقتی متنِ کاملِ پانویس همین صفحه چاپ شده باشد: <aside>متن پانویس</aside>. اگر فقط عدد یا علامتِ ارجاع (مثل [۱]) در متن هست ولی توضیحش روی همین صفحه نیست، همان عدد را عیناً داخل متنِ اصلی نگه‌دار و هیچ‌وقت محتوای پانویس را حدس نزن یا از خودت نساز.
